...
// See: https://developer.amazon.c om/docs/echo-button-skills/control-echo-buttons.html#animate
...
export const RollCall = {
    NewSession(handlerInput: HandlerInput) {
    ...
    StartRollCall(handlerInput: HandlerInput) {
    ...
    HandleFirstButtonCheckIn(handlerInput: HandlerInput) {
    ...
    HandleSecondButtonCheckIn(handlerInput: HandlerInput) {
    ...
    HandleTimeout(handlerInput: HandlerInput) {
